...
set GOOS=linux
set GOARCH=amd64
go build -a -o milvus_bench_2_4_2_x86_64 milvus-bench-2.4.2.go

go mod tidy
set GOOS=linux
set GOARCH=arm64
go build -a -o milvus_bench_2_4_2_aarch64 milvus-bench-2.4.2.go
```

## (2) get started

```shell
chmod +x milvus_bench_2_4_2*
mv milvus_bench_2_4_2* milvus_bench
